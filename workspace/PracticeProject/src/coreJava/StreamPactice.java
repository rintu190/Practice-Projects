...
public class StreamPactice {
    public static void main(String[] args) {
        ...
        Map<String,Map<String,List<Employee>>> multipleFieldsNestedMap = employeesList.stream()
        .collect(Collectors.groupingBy(Employee::getDesignation,
        Collectors.groupingBy(Employee::getGender)));

        String separatedByComma = employeesList.stream().map(a ->a.getName())
        ...
        System.out.println("Group by on multiple properties" + multipleFieldsNestedMap);
